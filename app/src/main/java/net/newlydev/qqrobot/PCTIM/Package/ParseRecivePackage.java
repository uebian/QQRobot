...
public class ParseRecivePackage
{
	...
	public QQMessage parse0017()
	{
		...
		try
		{
			...
			//Util.log(String.format("收到消息：type:%d;restbyte:",message_datafactory)+Util.byte2HexString(body_decrypted));
			switch (type)
			{
				...
				case 732:
				{
				  Util.log(qqmessage.Group_uin+"撤回消息"+Util.byte2HexString(message_datafactory.data));
				  break;
				}
				default:
					{
